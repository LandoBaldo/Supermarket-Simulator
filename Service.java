...
/**
 * Represents a service amenity in the supermarket that the shopper can interact
 * with.
 */
public class Service {
    ...
    private String determineDescription(ServiceType type) {
        switch (type) {
            case ENTRANCE:
                return "Shoppers in the simulation spawn here.";
            case CART_STATION:
                return "Allows shoppers to get or return carts.";
            case BASKET_STATION:
                return "Allows shoppers to get or return baskets.";
            case PRODUCT_SEARCH:
                return "Allows shoppers to search for products in the supermarket.";
            case STAIRS:
                return "Allows shoppers to ascend or descend to the other floor.";
            case CHECKOUT_COUNTER:
                return "Where shoppers pay for their products.";
            case EXIT:
                return "Allows shoppers to leave the simulation.";
            default:
    ...
    public String interact(Shopper shopper, Supermarket supermarket) {
        switch (serviceType) {
            case ENTRANCE:
                return handleEntrance(shopper);
            case CART_STATION:
                return handleCartStation(shopper);
            case BASKET_STATION:
                return handleBasketStation(shopper);
            case PRODUCT_SEARCH:
                return handleProductSearch(shopper, supermarket);
            case STAIRS:
                return handleStairs(shopper);
            case CHECKOUT_COUNTER:
                return handleCheckout(shopper);
            case EXIT:
                return handleExit(shopper);
            default:
