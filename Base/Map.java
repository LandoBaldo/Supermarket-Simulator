...
public class Map {
    ...
    // 1. OUTER BORDER (#) - Rows 0 and 21, Columns 0 and 21
        ...
        addService(new Service(Service.ServiceType.STAIRS, 1, 15));           // Stairs at left
        addService(new Service(Service.ServiceType.PRODUCT_SEARCH, 8, 15));   // Info at column 8
        addService(new Service(Service.ServiceType.PRODUCT_SEARCH, 13, 15));  // Info at column 13
        addService(new Service(Service.ServiceType.STAIRS, 20, 15));          // Stairs at far right
    ...
    private void initializeSecondFloor() {
        ...
        // 2. ROW 1: CHILLED COUNTERS & WALLS
        // Basket station at column 1
        addService(new Service(Service.ServiceType.BASKET_STATION, 1, 1));

        // Chilled counters: columns 3-4
        addBlockOfRefrigerators(3, 6, 1, 1);

        // Chilled counters: columns 9-10
        addBlockOfRefrigerators(9, 12, 1, 1);

        // Chilled counters: columns 15-16
        addBlockOfRefrigerators(15, 18, 1, 1);

        // Cart station at column 20
        addService(new Service(Service.ServiceType.CART_STATION, 20, 1));

        // 3. ROWS 4-7: TOP AISLES
        // Aisle 18: Shelves at columns 2-3
        addBlockOfShelves(2, 3, 4, 7);

        // Aisle 17: Shelves at columns 6-7
        addBlockOfShelves(6, 7, 4, 7);

        // Aisle 16: Tables at columns 10-11
        addBlockOfTables(10, 11, 4, 7);

        // Aisle 15: Shelves at columns 14-15
        addBlockOfShelves(14, 15, 4, 7);

        // Aisle 14: Shelves at columns 17-18
        addBlockOfShelves(18, 19, 4, 7);

        // 4. ROWS 10-13: BOTTOM AISLES
        // Aisle 19: Shelves at columns 2-3
        addBlockOfShelves(2, 3, 10, 13);

        // Aisle 20: Shelves at columns 6-7
        addBlockOfShelves(6, 7, 10, 13);

        // Aisle 21: Tables at columns 10-11
        addBlockOfTables(10, 11, 10, 13);

        // Aisle 22: Shelves at columns 14-15
        addBlockOfShelves(14, 15, 10, 13);

        // Aisle 23: Shelves at columns 17-18
        addBlockOfShelves(18, 19, 10, 13);


        // 5. ROW 15: PRODUCT SEARCH STATIONS
        ...
        // Left wall block: columns 4-5, rows 16-17
        addBlockOfWalls(16, 17, 4, 5);

        // Center-left wall block: columns 9-10, rows 16-17
        addBlockOfWalls(16, 17, 10, 11);

        // Center-right wall block: columns 15-16, rows 16-17
        addBlockOfWalls(16, 17, 16, 17);

        // 7. ROW 20: TABLES & WALLS WITH STAIRS
        // Stairs at column 1
        ...
        // Tables: columns 11-12
        addBlockOfTables(9, 12, 20, 20);

        // Tables: columns 16-18
